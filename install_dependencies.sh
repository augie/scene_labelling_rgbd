...
echo
echo
echo "Now run the following command, modifying [SCENE_LABELLING_DIR] appropriately: "
echo " export PYTHONPATH=$PYTHONPATH:[SCENE_LABELLING_DIR]/svm-python-v204/pyobjs/build/lib.linux-x86_64-2.6/"
